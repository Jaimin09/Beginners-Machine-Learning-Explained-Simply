...
![Image](./ML blog assets/ai-and-dev.jpg "Artificial Intelligence")
...
![Image](./ML blog assets/Ai exponential.png)
...
![Image](./ML blog assets/housing prices.png)
...
![Image](./ML blog Assets/perpendicular distance.png)
...
The dataset I have used to train the model, is available here : <a href = "https://github.com/Jaimin09/Machine-Learning-Explained-in-Simple-Way/blob/master/data.txt"> Dataset </a>
...
plt.show()
```
![Image](./ML blog assets/datavis.png)
...
```
![Image](./ML blog assets/costs.png)
...
![Image](./ML blog assets/predictions.png)
